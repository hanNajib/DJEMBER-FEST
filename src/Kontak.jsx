...
function Kontak() {
  ...
  return (
    <>
      ...
      <div
        className={`${
          Open ? "h-full pt-3 max-h-full opacity-100 delay-500" : "hidden"
        } overflow-hidden transition-all duration-500 w-full bg-slate-200 z-10 border-2 border-t-0 border-slate-800`}
      >
        <div className="p-5">
