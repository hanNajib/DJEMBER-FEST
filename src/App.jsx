      ...
      ></div>
        ...
        <div className="w-[100%] flex pt-48 relative text-slate-50  ">
          <div className="text flex flex-col pl-5 md:pl-10 lg:pl-28 ">
            <p
              className=" gradient-text md:whitespace-nowrap judul text-[4rem] mb-3 md:mb-0 font-bebas_neue font-semibold md:text-[10rem] opacity-100"
        ...
        <div className="flex gap-7 relative top-2 left-1 scale-75 md:left-12 lg:left-28 md:justify-normal md:scale-100 opacity-100">
          <a
            href=""
