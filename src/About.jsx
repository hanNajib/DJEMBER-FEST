export default function About() {
    return(
        <div className="bg-neutral-800 w-screen h-full flex flex-col md:flex-row justify-center items-center mt-20 gap-20 relative pb-28 pt-12 md:px-28" id="about">
            ...
            <div className="relative">
                <img src="https://i.pinimg.com/enabled/564x/f5/c3/05/f5c30525b780e0524b796c93d6aded8f.jpg" alt="" className="px-5 pt-0 md:pt-0 md:px-0"/>
            </div>
        </div>
    )
}