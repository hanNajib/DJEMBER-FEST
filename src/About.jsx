export default function About() {
    return(
        <div className="overflow-x-hidden bg-neutral-800 w-full h-full flex flex-col md:flex-row justify-center items-center mt-20 gap-20 relative pb-28 pt-12 md:px-28" id="about">
