...
export default function Card({img, judul, deskripsi}) {
    return(
        <>
            <div
            className="w-[45vw] h-[80vw] md:w-[360px] md:h-[550px] rounded-xl bg-white flex justify-center flex-col gap-1 shadow-lg md:scale-95 md:hover:scale-100 transition ease-in duration-200 rounded-m1">
